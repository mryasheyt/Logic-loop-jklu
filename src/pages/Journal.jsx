                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full py-4 pl-14 pr-6 bg-background border-none rounded-[28px] text-sm font-medium focus:ring-4 focus:ring-primary/5 transition-all text-text-primary"
                        />
                    </div>
                </div>
