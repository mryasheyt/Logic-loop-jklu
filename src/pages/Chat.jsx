                ...
                <div className="max-w-5xl mx-auto flex gap-6 items-end">
                    <div className="flex-1 relative group">
                        <textarea
                            ...
                            className="w-full bg-background dark:bg-white/5 border-none rounded-[32px] p-6 pr-16 focus:ring-4 focus:ring-primary/5 resize-none max-h-40 text-base font-medium dark:text-white transition-all shadow-inner"
                            rows="1"
